  ...
  useEffect(() => {
    ...
    const fragmentShader = `
      ...
      void main() {
        ...
        gl_FragColor = vec4(r * 0.5, g * 0.2, b * 0.8, 1.0);
      }
    `
    ...
    const initScene = () => {
      ...
      const material = new THREE.RawShaderMaterial({
        vertexShader, fragmentShader, uniforms: refs.uniforms, side: THREE.DoubleSide, transparent: true
      })
    ...
    const animate = () => {
      if (refs.uniforms) refs.uniforms.time.value += 0.02
